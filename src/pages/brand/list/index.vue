          ...
          <div class="top_main">
            <div class="weui-flex">
              <div class="weui-flex__item">
                <p class="small_txt">今日获赞</p>
                <p class="big_txt">{{homeTotal.today_likes}}</p>
              </div>
              <div class="weui-flex__item">
                <p class="small_txt">明日获赞</p>
                <p class="big_txt">{{homeTotal.yesterday_likes}}</p>
              </div>
              <div class="weui-flex__item">
                <p class="small_txt">累计获赞</p>
                <p class="big_txt">{{homeTotal.total_likes}}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <ul class="ul_list " style="padding-bottom:40rpx;">
            <li v-for="(item,index) in list" :key="index" class="li_item light_bg ">
              ...
              <div class="item_nums weui-flex text-center ">
                <div class="weui-flex__item">
                  <p class="main_txt">{{item.today_likes}}</p>
                  <p class="sub_txt dark_8e fs12">今日</p>
                </div>
                <div class="weui-flex__item">
                  <p class="main_txt">{{item.yesterday_likes}}</p>
                  <p class="sub_txt dark_8e fs12">昨日</p>
                </div>
                <div class="weui-flex__item">
                  <p class="main_txt">{{item.total_likes}}</p>
