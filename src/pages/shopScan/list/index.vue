        ...
        <div class="padding15-h">
          <div class="section">
            <div class="weui-flex padding-bottom72 ">
              ...
              <div class="padding-left15 weui-flex__item flex_item_center bd fs24">{{info.today_scans}}</div>
              <div class="ft fs13 dark_8e flex_item_center">今日扫码</div>
            </div>
            <div class="weui-flex padding-bottom72 ">
              <div class="hd">
                <image class="img_84" src="../../../static/img/center/yesterday.png"></image>
              </div>
              <div class="padding-left15 weui-flex__item flex_item_center bd fs24">{{info.yesterday_scans}}</div>
              <div class="ft fs13 dark_8e flex_item_center">昨日扫码</div>
            </div>
            <div class="weui-flex">
              <div class="hd">
                <image class="img_84" src="../../../static/img/center/total.png"></image>
              </div>
              <div class="padding-left15 weui-flex__item  flex_item_center bd fs24">{{info.total_scans}}</div>
              <div class="ft fs13 dark_8e flex_item_center">累计扫码</div>
            </div>
          </div>
        </div>
